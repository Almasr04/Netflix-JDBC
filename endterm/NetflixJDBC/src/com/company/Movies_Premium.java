...
public class Movies_Premium extends Movies{
    public void showMovies() {
        ...
        try {
            ...
            String querySelect = "SELECT*FROM Movies_premium;";
    ...
    public void SelectMovie(String movie_name1) {
        ...
        try {
            ...
            //st = connection.prepareStatement(qry);
            st = connection.createStatement();
            String querySelect = "SELECT*FROM movies_premium WHERE movie_name='"+movie_name1+"';";
            rs = st.executeQuery(querySelect);
            while (rs.next()) {
                String movie_name = rs.getString(1);
                String genres = rs.getString(2);
